...
void handleAction(){
    ...
    String message = server.arg("plain");
     ...
     int warmth = message.substring(message.indexOf('$')+1).toInt();
      ...
      double warmth_factor = warmth/100.0;
      ...
      Serial.println("warmth factor:");
      Serial.println(warmth_factor);
      
      Serial.println("out1:");
      Serial.println((brightness*(1-warmth_factor))/100.0*255);

      Serial.println("out2:");
      Serial.println((brightness*warmth_factor)/100.0*255);


     analogWrite(out1pin, (brightness*(1-warmth_factor))/100.0*255);
     analogWrite(out2pin, (brightness*warmth_factor)/100.0*255);
